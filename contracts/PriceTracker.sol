...
contract PriceTracker {
    ...
    event UpdatedPrice(uint8 id, uint64 oldPrice, uint64 newPrice, string message);
    ...
    function updatePrice(uint8 _nftId, uint64 _price) public {
        ...
        require(oldPrice != newPrice, "Old Price and New Price are the same value");
        nfts[_nftId] = newPrice;
        emit UpdatedPrice(_nftId,oldPrice,newPrice,"Successfuly updated the price");
